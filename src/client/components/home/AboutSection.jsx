...
const AboutSection = () => {
    return (
        <React.Fragment>
            ...
            <Typography paragraph>
                I am a Software Engineer with more than 5 years of experience. I graduated from Saint Petersburg State Institute of Technology (Technical Univetsity) in Russia with a master's equivalent degree in computer science. Currently I work in a bank developing financial services that are used by customers from around the world and I am using technologies like C#, .NET, JavaScript, React.js, Oracle Database.
            </Typography>
